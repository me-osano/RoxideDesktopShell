...
Singleton {
  ...
  Connections {
    ...
    function onNocturnalPerformanceModeChanged() {
      const isEnabled = PowerProfileService.nocturnalPerformanceMode;
  ...
  function init() {
    ...
    Qt.callLater(() => {
                   ...
                   wasPerformanceModeEnabled = PowerProfileService.nocturnalPerformanceMode;
                   // Execute startup hook
                   executeStartupHook();
                 });
  }
