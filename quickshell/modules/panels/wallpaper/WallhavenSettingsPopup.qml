...
Popup {
  ...
  TextMetrics {
    ...
    text: "Managed via NOCTURNAL_WALLHAVEN_API_KEY environment variable."
  ...
  contentItem: ColumnLayout {
    ...
    ColumnLayout {
      ...
      RTextInput {
        ...
        placeholderText: WallhavenService.apiKeyManagedByEnv ? "Managed via NOCTURNAL_WALLHAVEN_API_KEY environment variable." : "Enter your Wallhaven API Key"
