...
RBox {
  ...
  readonly property bool isDayTime: WeatherService.isDayTime
  ...
  ColumnLayout {
    ...
    RowLayout {
      ...
      RowLayout {
        ...
        RIcon {
          ...
          icon: weatherReady ? WeatherService.weatherSymbolFromCode(currentWeatherCode, isDayTime) : "weather-cloud-off"
        ...
        ColumnLayout {
          ...
          RowLayout {
            ...
            RText {
              text: weatherReady ? `(${WeatherService.weather?.timezone_abbreviation || ""})` : ""
              pointSize: Style.fontSizeXS
              color: Color.mOnSurfaceVariant
              visible: WeatherService.weather && showLocation && !Settings.data.location.hideWeatherTimezone
            }
          }
        }
      }
    ...
    RowLayout {
      ...
      Repeater {
        model: weatherReady ? Math.min(root.forecastDays, WeatherService.weather?.daily?.time?.length || 0) : 0
    ...
    Loader {
      ...
      sourceComponent: RBusyIndicator {}
    }
  }
}
