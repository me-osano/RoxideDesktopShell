...
PopupWindow {
  ...
  // Font scale calculation matching RText behavior
  ...
  // For measuring grid cell widths - must match actual RText font
  TextMetrics {
    id: cellMetrics
  ...
  // For measuring grid row height - hidden RText matches actual grid items exactly
  RText {
    id: rowHeightMeasure
    visible: false
  ...
  // Calculate grid dimensions using measurements that match actual RText rendering
  function calculateGridSize() {
    ...
    // Calculate total height using hidden RText for accurate row height
