...
Item {
  ...
  readonly property bool weatherReady: Settings.data.location.weatherEnabled && WeatherService.weatherReady
    ...
    ColumnLayout {
      ...
      RowLayout {
        ...
        Rectangle {
          ...
          Layout.fillWidth: !(Settings.data.location.weatherEnabled && WeatherService.weatherReady)
          ...
          Loader {
            ...
            z: 0
            sourceComponent: RLinearSpectrum {
              anchors.fill: parent
          ...
          Loader {
            ...
            z: 0
            sourceComponent: RMirroredSpectrum {
              anchors.fill: parent
              values: CavaService.values
              fillColor: Color.mPrimary
              opacity: 0.4
        ...
        // Current weather
        RowLayout {
          visible: Settings.data.location.weatherEnabled && WeatherService.weatherReady
          Layout.preferredWidth: 180
          spacing: Style.marginM

          RIcon {
            Layout.alignment: Qt.AlignVCenter
            icon: weatherReady ? WeatherService.weatherSymbolFromCode(WeatherService.currentWeatherCode, WeatherService.isDayTime) : "weather-cloud-off"
          ...
          ColumnLayout {
            ...
            RowLayout {
              ...
              RText {
                text: {
                  var wind = WeatherService.windSpeed;
                  var unit = "km/h";
                  if (Settings.data.location.useFahrenheit) {
            ...
            RowLayout {
              ...
              RText {
                text: WeatherService.humidity > 0 ? WeatherService.humidity + "% humidity" : ""
                pointSize: Style.fontSizeM
                color: Color.mOnSurfaceVariant
              }
            }
        ...
        RowLayout {
          ...
          Repeater {
            ...
            delegate: ColumnLayout {
              ...
              RText {
                text: {
                  var weatherDate = new Date(WeatherService.weather.daily.time[index].replace(/-/g, "/"));
              ...
              RIcon {
                ...
                icon: WeatherService.weatherSymbolFromCode(WeatherService.weather.daily.weathercode[index])
                pointSize: Style.fontSizeXL
                color: Color.mOnSurfaceVariant
              }
              ...
              RText {
                text: {
                  var max = WeatherService.weather.daily.temperature_2m_max[index];
                  var min = WeatherService.weather.daily.temperature_2m_min[index];
                  if (Settings.data.location.useFahrenheit) {
                    max = WeatherService.celsiusToFahrenheit(max);
                    min = WeatherService.celsiusToFahrenheit(min);
                  }
                  max = Math.round(max);
                  min = Math.round(min);
                  return max + "°/" + min + "°";
