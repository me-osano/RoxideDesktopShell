...
/*
* RContextMenu - Popup-based context menu for use inside panels and dialogs
*
...
*
* For bar widgets and top-level window contexts, use RPopupContextMenu instead,
