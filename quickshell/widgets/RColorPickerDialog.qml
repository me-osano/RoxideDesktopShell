...
Popup {
  ...
  property int editMode: RColorPickerDialog.EditMode.R
        ...
        RowLayout {
          ...
          ColumnLayout {
            ...
            RowLayout {
              ...
              RRadioButton {
                ...
                font.weight: Style.fontWeightMedium
                checked: true
                onClicked: root.editMode = RColorPickerDialog.EditMode.R
            ...
            RowLayout {
              ...
              RRadioButton {
                ...
                text: "G"
                font.weight: Style.fontWeightMedium
                onClicked: root.editMode = RColorPickerDialog.EditMode.G
                Layout.fillWidth: false
              }
            ...
            RowLayout {
              ...
              RRadioButton {
                ...
                text: "B"
                font.weight: Style.fontWeightMedium
                onClicked: root.editMode = RColorPickerDialog.EditMode.B
                Layout.fillWidth: false
              }
            ...
            RowLayout {
              ...
              RRadioButton {
                ...
                font.weight: Style.fontWeightMedium
                checked: true
                onClicked: root.editMode = RColorPickerDialog.EditMode.H
                Layout.fillWidth: false
              }
            ...
            RowLayout {
              ...
              RRadioButton {
                ...
                text: "S"
                font.weight: Style.fontWeightMedium
                onClicked: root.editMode = RColorPickerDialog.EditMode.S
                Layout.fillWidth: false
              }
            ...
            RowLayout {
              ...
              RRadioButton {
                ...
                text: "V"
                font.weight: Style.fontWeightMedium
                onClicked: root.editMode = RColorPickerDialog.EditMode.V
                Layout.fillWidth: false
              }
          ...
          RowLayout {
            ...
            RColorSlider {
              id: selectedSlider
              Layout.fillHeight: true
              rainbowMode: root.editMode === RColorPickerDialog.EditMode.H
              topColor: {
                if (rainbowMode)
                  return "transparent";
                switch (root.editMode) {
                case RColorPickerDialog.EditMode.R:
                  return "#FF0000";
                case RColorPickerDialog.EditMode.G:
                  return "#00FF00";
                case RColorPickerDialog.EditMode.B:
                  return "#0000FF";
                default:
                  return "#FFFFFF";
                }
              ...
              Binding {
                ...
                value: {
                  ...
                  case RColorPickerDialog.EditMode.H:
                    return root.displayHue;
                  case RColorPickerDialog.EditMode.S:
                    return root.selectedColor.hsvSaturation;
                  case RColorPickerDialog.EditMode.V:
