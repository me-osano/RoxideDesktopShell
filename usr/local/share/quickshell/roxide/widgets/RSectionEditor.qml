...
RBox {
  ...
  function openWidgetSettings(index, widgetData) {
    ...
    if (isPlugin) {
      ...
      var pluginId = widgetId.replace("plugin:", "");
      if (!pluginId) {
        Logger.e("RSectionEditor", "Plugin settings not found for empty plugin id");
        return;
      }
      ...
      function instantiateAndOpen() {
        ...
        if (dialog) {
          ...
          Logger.e("RSectionEditor", "Failed to create settings dialog instance");
        }
      }
      ...
      if (component.status === Component.Ready) {
        ...
        Logger.e("RSectionEditor", component.errorString());
      } else {
